<template>
  <section class="v-layout v-layout__classic w-[100%] h-[100%]">
    ...
    <div
      :class="`v-layout-content absolute top-0 h-[100%] ${
        collapse
    ...
    >
      ...
      >
        ...
        >
          Copyright&copy;2023-present VZeroAdmin
        </div>
      </ElScrollbar>
    </div>
  </section>
...
console.log(
  'Abp.Identity.Lockout.LockoutDuration:',
  settingStore.getVal('Abp.Identity.Lockout.LockoutDuration')
)
console.log(
  'Abp.Identity.Password.RequireLowercase',
  settingStore.enabled('Abp.Identity.Password.RequireLowercase')
)
...
console.log(
  ...
  featureStore.getVal('SettingManagement.AllowChangingEmailSettings')
)
console.log(
  'SettingManagement.Enable',
  featureStore.enabled('SettingManagement.Enable')
)
