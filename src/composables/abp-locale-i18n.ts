...
function reMerge(messages: any, mergeLocaleMessage: any) {
  ...
  if (
    ...
    localizationStore.localization!.currentCulture != null
  ) {
    console.log(
      'layout:localizationStore.localization',
    ...
    mergeLocaleMessage(
      LangMapI18N[localizationStore.localization!.currentCulture!.cultureName!],
      msg
    )
  }
