...
namespace CompanyName.ProjectName.Web.Menus;

public class ProjectNameMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ProjectNameMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<ProjectNameResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                ProjectNameMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
