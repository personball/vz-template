...
declare global {
  ...
  const Schema: typeof import('@formily/json-schema')['Schema']
  ...
  const createSchemaField: typeof import('@formily/vue')['createSchemaField']
  ...
  const setToken: typeof import('./composables/token')['setToken']
